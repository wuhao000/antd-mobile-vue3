    ...
    return (<div>
      ...
      <List title="表单" disabled={this.state.disabled}
        ...
        <m-date-picker-item required={true} title="时间选择" mode="time" value={new Date()} error={this.state.error}
                            errorDisplayType={this.state.errorDisplayType} errorMessage={this.state.errorMessage}/>
        <m-calendar-item required={true} title="日期范围" value={[new Date(), new Date()]}/>
        ...
        <m-radio-popup-list required={true} title="弹出单选"
                            ...
                            errorDisplayType={this.state.errorDisplayType} errorMessage={this.state.errorMessage}/>
        <m-checkbox-popup-list required={true} title="弹出多选" options={options} error={this.state.error}
                               value={[1, 2]}
                               errorDisplayType={this.state.errorDisplayType} errorMessage={this.state.errorMessage}/>
        <m-switch-item title="开关" v-model={this.state.switch} error={this.state.error}
                       errorDisplayType={this.state.errorDisplayType} errorMessage={this.state.errorMessage}/>
        <m-textarea required={true} rows={5} title="长文本"
        ...
        <m-slider-item title="滑动输入条" v-model={this.state.slider} error={this.state.error}
                       errorDisplayType={this.state.errorDisplayType} errorMessage={this.state.errorMessage}/>
        <m-radio-list required={true} title="单选" options={options} error={this.state.error}
                      errorDisplayType={this.state.errorDisplayType} errorMessage={this.state.errorMessage}/>
        <m-checkbox-list required={true} title="多选" options={options} error={this.state.error}
                         errorDisplayType={this.state.errorDisplayType} errorMessage={this.state.errorMessage}/>
      </List>
    </div>);
  }
